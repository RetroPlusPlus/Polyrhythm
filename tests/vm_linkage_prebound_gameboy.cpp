// A program that constructs a pre-bound Game Boy Color machine.
//
// Vm::GBC names the Game Boy core in its own constructor, so the core is in this binary under every
